...
const BOARD = [
  ...
  { id: 32, name: 'Dahoman', type: 'horse', group: 'tm_zelena', groupColor: '#16a34a', groupSize: 3, price: 6000, rents: [500, 2600, 7800, 18000, 22000, 25500], tokenCost: 4000, bigTokenCost: 4000 },
  { id: 33, name: 'Finance', type: 'finance' },
  { id: 34, name: 'Gira', type: 'horse', group: 'tm_zelena', groupColor: '#16a34a', groupSize: 3, price: 6400, rents: [560, 3000, 9000, 20000, 24000, 28000], tokenCost: 4000, bigTokenCost: 4000 },
